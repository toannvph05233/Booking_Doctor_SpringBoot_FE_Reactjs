...
const RentalHistory = () => {
        ...
        const showCancelBookingConfirm = (booking) => {
            if (new Date(booking.startTime) - new Date() > (1000 * 60 * 60 * 24)) {
                ...
                Swal.fire({
                    title: 'Thời gian hủy nhỏ hơn 1 ngày tính tới ngày đặt, bạn sẽ chịu khoản phí 50%',
                    icon: 'error',
                    showCancelButton: true,
                    confirmButtonText: 'Xác nhận',
                    cancelButtonText: 'Đóng',
        ...
        return (
            <div className='col-9'>
                <div>
                    ...
                    <span className={'text-danger'}>* Lưu ý :Nếu hủy đặt lịch trước ngày đặt lịch 1 ngày , bạn sẽ phải chịu một khoản phí bằng 50% tiền phí</span>
