                ...
                <div className="container py-5">
                    <div className="row g-5">
                        <div className="col-6">
                            ...
                            <p className="mb-2"><i className="fa fa-map-marker-alt me-3"></i>ĐT Mon City, Mỹ Đình 2, Q. Nam Từ Liêm, HN</p>
                            <p className="mb-2"><i className="fa fa-phone-alt me-3"></i>099999999999</p>
                            <p className="mb-2"><i className="fa fa-envelope me-3"></i> info@gmail.vn</p>
